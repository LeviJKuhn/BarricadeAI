- Vault is under C:\Users\LeviJKuhn\Documents\ImportantFiles\Obsidian Vaults\BarricadeAI
- Created Vault by saying new Vault and choosing Obsidian Vaults folder
...
- Under Templates
	...
	- In frontmatter add:
		...
		- Version: 0.1
		- tags: 
	- Add the various skeleton outlines for this template (pulled from community_finder vault)
...
```	
	...
	- Open a shell at the directory of the vault (C:\Users\LeviJKuhn\Documents\ImportantFiles\Obsidian Vaults\BarricadeAI")
	- git init
	- Create .gitignore
```
# OS junk
